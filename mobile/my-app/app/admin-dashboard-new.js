...
//             const res = await axios.get('http://10.113.44.221:5000/api/users', {
...
//         setLoading(true);
//         try {
//             const res = await axios.get('http://10.113.44.221:5000/api/books');
//             setBooks(res.data);
//         } catch (err) {
//             console.error(err);
...
//         try {
//             await axios.delete(`http://10.113.44.221:5000/api/users/${userId}`, {
//                 headers: {'x-auth-token': token}
//             });
...
//         e.preventDefault();
//         try {
//             await axios.post('http://10.113.44.221:5000/api/books', newBook, {
//                 headers: {'x-auth-token': token}
//             });
...
//         e.preventDefault();
//         try {
//             await axios.put(`http://10.113.44.221:5000/api/books/${selectedBook._id}`, selectedBook, {
//                 headers: {'x-auth-token': token}
//             });
...
//         try {
//             await axios.delete(`http://10.113.44.221:5000/api/books/${bookId}`, {
//                 headers: {'x-auth-token': token}
//             });
