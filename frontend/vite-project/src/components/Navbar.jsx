        ...
        <>
            <nav className="navbar navbar-expand-lg navbar-light bg-white shadow-sm">
                <div className="container">
                    <Link className="navbar-brand d-flex align-items-center fw-bold" style={{fontSize: '1.6rem'}}
                          to="/">
                        <img
                            src={logo}
                            alt="LearnOva Logo"
                    ...
                    <div className={`collapse navbar-collapse ${isOpen ? 'show' : ''}`} id="navbarNav">
                        <ul className="navbar-nav ms-auto align-items-center">
                            ...
                            {user ? (
                                ...
                                <>
                                    <li className="nav-item">
                                        <Link className="nav-link mx-lg-2 fw-semibold" to="/login"
                                              onClick={() => setIsOpen(false)}>Login</Link>
                                    </li>
                                    <li className="nav-item">
                                        <Link className="btn text-white px-4 rounded-pill shadow-sm"
                                              style={{backgroundColor: '#C5A059'}} to="/Register"
                                              onClick={() => setIsOpen(false)}>
                                            Sign Up
                                        </Link>
                                    </li>
